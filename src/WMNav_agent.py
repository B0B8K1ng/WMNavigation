...
class WNAgentV2(VLMNavAgent):
    ...
    def make_plan(self, pano_images, previous_subtask, goal_reason, goal):
        ...
        try:
            goal_flag, first_subtask, second_subtask, third_subtask = response['Flag'], response['First'], response['Second'], response['Third']
        except:
            print("planning failed!")
            print('response:', response)
            goal_flag, first_subtask, second_subtask, third_subtask = False, '{}', '{}', '{}'

        return goal_flag, first_subtask, second_subtask, third_subtask
